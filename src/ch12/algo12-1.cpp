 ...
 static void Q(RedType &f,RcdType g)
 { // 将f和g归并成一个f结构的记录
   f.amount+=g.amount;
 }

 static void MergeFile(FILE *f,FILE *g,FILE *h)
 ...
 static void print(RedType t)
 {
   printf("%6d%4d\n",t.accounts,t.amount);
 }

 static void printc(RcdType t)
 {
