 ...
 static SElemType Precede(SElemType t1,SElemType t2) // 同algo3-6.cpp
 ...
 static Status In(SElemType c) // 几乎与algo3-6.cpp相同
 { // 判断c是否为运算符
   switch(c)
   {
     case'+':
 ...
 static SElemType Operate(SElemType a,SElemType theta,SElemType b) // 有改动
 {
   SElemType c;
   switch(theta)
   {
 ...
 static SElemType EvaluateExpression() // 有改动
