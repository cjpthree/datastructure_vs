 ...
 static Status InitDSTable(DLTree &DT)
 { // 操作结果: 构造一个空的双链键树DT
   DT=NULL;
   return OK;
 }

 static void DestroyDSTable(DLTree &DT)
 ...
 static Record *SearchDLTree(DLTree T,KeysType K)
 ...
 static void InsertDSTable(DLTree &DT,Record *r)
 ...
 static struct SElemType // 定义栈元素类型
 {
   char ch;
   DLTree p;
 };
 #include"c3-1.h"
 #include"bo3-1.cpp"
 static void TraverseDSTable(DLTree DT,void(*Vi)(Record))
