 ...
 static Status Creat_Seq(SSTable &ST,int n)
 ...
 static Status Creat_Ord(SSTable &ST,int n)
 ...
 static Status Destroy(SSTable &ST)
 ...
 static int Search_Bin(SSTable ST,KeyType key)
 ...
 static Status Traverse(SSTable ST,void(*Visit)(ElemType))
