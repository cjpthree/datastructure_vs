 ...
 static Status InitDSTable(TrieTree &T)
 { // 操作结果: 构造一个空的Trie键树T
   T=NULL;
   return OK;
 }

 static void DestroyDSTable(TrieTree &T)
 ...
 static Record *SearchTrie(TrieTree T,KeysType K)
 ...
 static void InsertTrie(TrieTree &T,Record *r)
 ...
 static void TraverseDSTable(TrieTree T,Status(*Vi)(Record*))
